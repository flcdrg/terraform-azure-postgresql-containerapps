...
az role assignment create --assignee "$APP_ID" --role "Key Vault Purge Operator" --scope "/subscriptions/$SUBSCRIPTION_ID" # For purging key vault from Destroy pipeline
